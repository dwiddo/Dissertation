...
#declare font_scale = 0.350696;

#declare font_name = "arial.ttf";

ccdc_perspective_camera( < 0, 0, 20093.4 >, 0.05 )
...
union {
    #declare world_orientation = transform { matrix <
        -0.354165, -0.935182, 0.00138024,
        0.244255, -0.0910775, 0.965424,
        -0.902722, 0.342257, 0.260679,
        8.92258e-05, -0.541395, 0 > };
