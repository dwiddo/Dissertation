...
"""
This file depends on one other in this repository: ase_tools.py.
If it is in the same directory as this file, drawing should work.
"""
...
def draw(atoms, show_unit_cell=True,
    ...
    if isinstance(atoms, str):
        ...
        try:
            ...
            print("Could not find .cif file to draw.")
            return
